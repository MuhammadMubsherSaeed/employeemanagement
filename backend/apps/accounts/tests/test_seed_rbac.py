...
class SeedRbacTests(TestCase):
    def test_seed_rbac_is_idempotent(self) -> None:
        ...
        self.assertTrue(manager.permissions.filter(code="notifications.view").exists())
        self.assertFalse(manager.permissions.filter(code="notifications.manage").exists())
        self.assertTrue(employee.permissions.filter(code="notifications.mark_read").exists())
        self.assertFalse(employee.permissions.filter(code="notifications.manage").exists())
        self.assertTrue(admin.permissions.filter(code="dashboard.admin.view").exists())
        self.assertTrue(manager.permissions.filter(code="dashboard.manager.view").exists())
        self.assertTrue(manager.permissions.filter(code="dashboard.employee.view").exists())
        self.assertFalse(manager.permissions.filter(code="dashboard.admin.view").exists())
        self.assertTrue(employee.permissions.filter(code="dashboard.employee.view").exists())
        self.assertFalse(employee.permissions.filter(code="dashboard.admin.view").exists())

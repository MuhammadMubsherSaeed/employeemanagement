...
class NotificationErrorMapper {
  ...
  static const String notFound = 'This notification could not be found.';
  static const String relatedNotFound =
      'This item is no longer available.';
  static const String network =
      'Unable to connect to the server. Please check your internet connection.';

  static String message(Object error, {bool relatedEntity = false}) {
    ...
    if (exception is NotFoundException) {
      return relatedEntity ? relatedNotFound : notFound;
    }
    ...
    if (exception is ValidationException) {
      ...
      if (fields != null &&
          fields.isNotEmpty &&
          fields.values.first.isNotEmpty) {

...
class EmployeeErrorMapper {
  EmployeeErrorMapper._();

  static const String generic = 'Something went wrong. Please try again.';
  static const String forbidden = 'You do not have access to this employee.';
  static const String notFound = 'This employee could not be found.';
